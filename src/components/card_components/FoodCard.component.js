...
const FoodCard = ({ event }) => {
	...
	return (
		<div
			className={`${closeClass} sm:max-w-[12rem] sm:min-w-[9.15rem] 2xl:max-w-[14rem] min-w-[9.15rem] w-[45%] lg:w-full p-1 rounded-lg min-h-[14.25rem] relative mb-7 cursor-pointer`}
		>
